...
public class DialogPanelChoixForum extends JPanel {
	...
	private TreeMap<String, ForumModel> treeMapForums;
	private JCheckBox chkUpdate = new JCheckBox();

	public DialogPanelChoixForum(ResourceBundle bundleOperationsListe, TreeMap<String, ForumModel> treeMapForums, String nomForumEnCours) {
		this.bundleOperationsListe = bundleOperationsListe;
		this.treeMapForums = treeMapForums;
	...
	public void createGui() {
		...
		for (final ForumModel forum : treeMapForums.values()) {
