...
public class TabConversationsForumModel extends AbstractTableModel {
	...
	public TabConversationsForumModel(Set<ConversationModel> setConversations, ResourceBundle conversationsListe) {
		super();
		this.listConversations = new ArrayList<ConversationModel>(setConversations);
		this.conversationsListe = conversationsListe;
		this.types = new Class[] { Integer.class, String.class, Integer.class, Date.class, Date.class, Integer.class, Integer.class, Integer.class, Boolean.class, String.class };
		this.columnNames = new String[] { conversationsListe.getString("txt_Conversation"), conversationsListe.getString("txt_Topic"), "<html>" + conversationsListe.getString("txt_NbreVues") + "</br></html>", conversationsListe.getString("txt_Debut"), conversationsListe.getString("txt_Fin"),
	...
	public Object getValueAt(int row, int col) {
		...
		case 2:
			return listConversations.get(row).getfNbreVues();
		case 3:
