...
public class DialogPanelInfoLocuteur extends JPanel {
	...
	public DialogPanelInfoLocuteur(LocuteurModel locuteur) {
	...
	public void createGui() {
		...
		JLabel labConversations = new JLabel("Conversations : ");
		...
		JLabel labConversationsCollectives = new JLabel("Conversations collectives : ");
		...
		JLabel labConversationsCollectivesLancees = new JLabel("Conversations collectives lancées : ");
		...
		JLabel labMessagesConversationsCollectives = new JLabel("Messages dans les conversations collectives : ");
		...
		JLabel labLd = new JLabel("Locuteur dominant : ");
		labLd.setFont(gras);
		JLabel txtLd = new JLabel((locuteur.isLd() == false) ? "Non" : "Oui");
		panelLd.add(labLd);
		panelLd.add(txtLd);
		...
		if (locuteur.getfStatDateRegistrered() != null) {
			...
			JLabel labRole = new JLabel("Rôle : ");
			...
			JLabel labQualite = new JLabel("Qualité : ");
			...
			JLabel labActivite = new JLabel("Activité : ");
			...
			JLabel labEtoiles = new JLabel("Rang : ");
